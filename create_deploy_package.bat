...
REM Set variables
set DEPLOY_DIR=inmotion_deploy
set ZIP_FILE=django_fileconvert_api.zip
...
REM Copy Django project and apps
xcopy fileconvert_api %DEPLOY_DIR%\fileconvert_api\ /e /i /q
...
(
echo Django File Converter API - InMotion Hosting Deployment Package
echo ================================================================
echo.
...
echo.
echo Your PDF to TXT conversion functionality will be available immediately!
